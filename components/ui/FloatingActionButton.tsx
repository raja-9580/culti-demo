          ...
          {actions.map((action, idx) => (
            <React.Fragment key={idx}>
              {action.href ? (
                <Link
                  href={action.href}
                  className="flex items-center gap-2 bg-dark-surface border border-gray-800/40 rounded-lg px-3 py-2 text-sm text-gray-300 hover:text-accent-leaf hover:border-accent-leaf/40 transition-all"
                >
